...
def init_db():
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS games(id INTEGER PRIMARY KEY, title TEXT, platform TEXT, year TEXT, description TEXT, rating TEXT)")
